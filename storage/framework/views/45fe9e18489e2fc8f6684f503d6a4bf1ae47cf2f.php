                                           ...
                                           <ul class="sclist">
                                               <?php $__currentLoopData = $category->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <li><i class="fa fa-caret-right"></i> <?php echo e($scategory->name); ?> 
                                                      ...
                                                      <a href="#" onclick="confirm('Are you sure, You want to delete this subcategory?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSubcategory(<?php echo e($scategory->id); ?>)" class="slink"><i class="fa fa-times text-danger"></i></a>
                                                  </li>
...
<?php /**PATH F:\New folder\copy\laravel8ecommerce\resources\views/livewire/admin/admin-category-component.blade.php ENDPATH**/ ?>