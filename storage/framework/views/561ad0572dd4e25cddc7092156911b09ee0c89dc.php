                        ...
                        <div class="product-gallery" wire:ignore>
                            <ul class="slides">
                                ...
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($image): ?>
                                        <li data-thumb="<?php echo e(asset('assets/images/products')); ?>/<?php echo e($image); ?>">
                                            <img src="<?php echo e(asset('assets/images/products')); ?>/<?php echo e($image); ?>" alt="<?php echo e($product->name); ?>" />
                                        </li>
                                    <?php endif; ?>    
                                        ...
                                        <ol class="commentlist">
                                            ...
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container">
                                                    <img alt="<?php echo e($orderItem->order->user->name); ?>" src="<?php echo e(asset('assets/images/profile')); ?>/<?php echo e($orderItem->order->user->profile->image); ?>" height="80" width="80">
...
<?php /**PATH F:\New folder\copy\laravel8ecommerce\resources\views/livewire/details-component.blade.php ENDPATH**/ ?>