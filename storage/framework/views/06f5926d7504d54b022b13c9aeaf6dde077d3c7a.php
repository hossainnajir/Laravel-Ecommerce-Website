                                      ...
                                      <?php if(Auth::user()->utype === 'ADM'): ?>
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item" >
                                                    <a title="Attributes" href="<?php echo e(route('admin.attributes')); ?>">Attributes</a>
                                                </li>
                                                <li class="menu-item" >
...
} elseif ($_instance->childHasBeenRendered('QhrsC65')) {
    $componentId = $_instance->getRenderedChildComponentId('QhrsC65');
    $componentTag = $_instance->getRenderedChildComponentTagName('QhrsC65');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QhrsC65');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('QhrsC65', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('PAeauru')) {
    $componentId = $_instance->getRenderedChildComponentId('PAeauru');
    $componentTag = $_instance->getRenderedChildComponentTagName('PAeauru');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PAeauru');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('PAeauru', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('xscYIIo')) {
    $componentId = $_instance->getRenderedChildComponentId('xscYIIo');
    $componentTag = $_instance->getRenderedChildComponentTagName('xscYIIo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xscYIIo');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('xscYIIo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('RzHLpAP')) {
    $componentId = $_instance->getRenderedChildComponentId('RzHLpAP');
    $componentTag = $_instance->getRenderedChildComponentTagName('RzHLpAP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RzHLpAP');
} else {
    $response = \Livewire\Livewire::mount('footer-component');
    $html = $response->html();
    $_instance->logRenderedChild('RzHLpAP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH F:\New folder\copy\laravel8ecommerce\resources\views/layouts/base.blade.php ENDPATH**/ ?>