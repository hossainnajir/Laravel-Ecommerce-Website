            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    <?php if(Session::has('coupon')): ?>
                        ...
                        <p class="summary-info"><span class="title">Subtotal with Discount</span><b class="index">$<?php echo e(number_format($subtotalAfterDiscount,2)); ?></b></p>
                            ...
                            <div class="summary-item">
                                <form wire:submit.prevent="applyCouponCode">
                                    ...
                                    <?php if(Session::has('coupon_message')): ?>
                                        <div class="alert alert-danger" role="alert"><?php echo e(Session::get('coupon_message')); ?></div>
                                    <?php endif; ?>
                                    <p class="row-in-form">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="delete">
                            <a href="#" wire:click.prevent="deleteFromSaveForLater('<?php echo e($item->rowId); ?>')" class="btn btn-delete" title="">
                                <span>Delete from save for latter</span>
                                <i class="fa fa-times-circle" aria-hidden="true"></i>
                            </a>
                        </div>
                    </li>
...
<?php /**PATH F:\New folder\copy\laravel8ecommerce\resources\views/livewire/cart-component.blade.php ENDPATH**/ ?>