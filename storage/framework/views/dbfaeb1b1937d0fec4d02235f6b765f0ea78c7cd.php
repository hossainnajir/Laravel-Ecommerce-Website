...
<?php endif; ?>
                                <form name="frm-login" method="POST" action="<?php echo e(route('password.update')); ?>">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="email" id="frm-login-uname" name="email" placeholder="Type your email address" value="<?php echo e($request->email); ?>" required autofocus>
                                    </fieldset>
...
<?php endif; ?>
<?php /**PATH F:\New folder\copy\laravel8ecommerce\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>