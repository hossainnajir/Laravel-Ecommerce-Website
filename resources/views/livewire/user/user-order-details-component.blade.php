                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table">
                            <tr>
                                <th>First Name</th>
                                <td>{{$order->shippings->firstname}}</td>
                                <th>Last Name</th>
                                <td>{{$order->shippings->lastname}}</td>
                            </tr>
                            <tr>
                                <th>Phone</th>
                                <td>{{$order->shippings->mobile}}</td>
                                <th>Email</th>
                                <td>{{$order->shippings->email}}</td>
                            </tr>
                            <tr>
                                <th>Line1</th>
                                <td>{{$order->shippings->line1}}</td>
                                <th>Line2</th>
                                <td>{{$order->shippings->line2}}</td>
                            </tr>
                            <tr>
                                <th>City</th>
                                <td>{{$order->shippings->city}}</td>
                                <th>Province</th>
                                <td>{{$order->shippings->province}}</td>
                            </tr>
                            <tr>
                                <th>Country</th>
                                <td>{{$order->shippings->country}}</td>
                                <th>Zipcode</th>
                                <td>{{$order->shippings->zipcode}}</td>
                            </tr>
                        </table>
                    </div>
                </div>
